...
public class PerfilUsuarioExisteException extends BusinessException {

    /** La Constante serialVersionUID. */
    private static final long serialVersionUID = 2024202931903996420L;
    
    /** La Constante ERROR_KEY. */
    private static final String ERROR_KEY = PerfilUsuarioExisteException.class.getName();

    /**
     * Constructor de la clase PerfilNombreExisteException.
     */
    public PerfilUsuarioExisteException() {
        super(ERROR_KEY);
    }
     ...
     */
    public PerfilUsuarioExisteException(Object param) {
