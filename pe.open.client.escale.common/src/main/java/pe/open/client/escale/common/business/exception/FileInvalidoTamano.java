...
public class FileInvalidoTamano extends BusinessException {

    /** La Constante serialVersionUID. */
    private static final long serialVersionUID = -3706220987591043731L;
    
    /** La Constante ERROR_KEY. */
    private static final String ERROR_KEY = FileInvalidoTamano.class.getName();
     ...
     */
    public FileInvalidoTamano(String parameter) {
