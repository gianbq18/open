...
public class CuentaUsuarioCaducadaException extends BusinessException {
    ...
    private static final String ERROR_KEY = CuentaUsuarioCaducadaException.class.getName();

	/**
	 * Constructor de la clase CuentaUsuarioExpiradaException.
	 */
    public CuentaUsuarioCaducadaException() {
        super(ERROR_KEY);
    }
     ...
     */
    public CuentaUsuarioCaducadaException(Object param) {
